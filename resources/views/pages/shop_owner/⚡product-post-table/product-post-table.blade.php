...
<div class="space-y-6">
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <p class="mb-2 text-[11px] font-bold uppercase tracking-[0.2em] text-slate-500">Owner inventory</p>
            <h1 class="text-3xl font-bold tracking-tight text-slate-900">Product posts</h1>
        </div>
